<?php /* Smarty version 2.6.19, created on 2008-08-27 17:25:17
         compiled from settingslist.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'settingslist.tpl', 10, false),array('modifier', 'htmlspecialchars', 'settingslist.tpl', 12, false),)), $this); ?>
<table id="list" style="width: 100%">
	<tr>
		<th class="id">&nbsp;</th>
		<th><?php echo $this->_tpl_vars['lang']['admincms']['category']; ?>
</th>
		<th><?php echo $this->_tpl_vars['lang']['admincms']['title']; ?>
</th>
		<th><?php echo $this->_tpl_vars['lang']['admincms']['value']; ?>
</th>
	</tr>
	<tbody>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['settings'][$this->_sections['ls']['index']]['category_name'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
			...
			<td><a href="<?php echo $this->_tpl_vars['settings'][$this->_sections['ls']['index']]['link']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['settings'][$this->_sections['ls']['index']]['name'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
</a></td>
			<td><a href="<?php echo $this->_tpl_vars['settings'][$this->_sections['ls']['index']]['link']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['settings'][$this->_sections['ls']['index']]['reg_value'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
</a></td>
		</tr>
		<?php endfor; endif; ?>
	</tbody>
