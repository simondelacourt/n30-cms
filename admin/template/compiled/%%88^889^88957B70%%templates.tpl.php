<?php /* Smarty version 2.6.19, created on 2008-08-16 16:12:02
         compiled from templates.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'templates.tpl', 11, false),array('modifier', 'htmlspecialchars', 'templates.tpl', 13, false),)), $this); ?>
...
$this->_sections['ls']['loop'] = is_array($_loop=$this->_tpl_vars['templates']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['templates'][$this->_sections['ls']['index']]['title'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
</a></td>
			<td><?php if ($this->_tpl_vars['templates'][$this->_sections['ls']['index']]['default'] == 'true'): ?><img src="<?php echo $this->_tpl_vars['baseurl']; ?>
/admin/style/icons/small/weather-clear.png" alt="default"/><?php endif; ?></td>
			<td>
				<?php if ($this->_tpl_vars['templates'][$this->_sections['ls']['index']]['installed'] == 1): ?>
				<?php echo $this->_tpl_vars['lang']['admincms']['installedok']; ?>

				<?php else: ?>
				<a href="<?php echo $this->_tpl_vars['templates'][$this->_sections['ls']['index']]['installurl']; ?>
"><?php echo $this->_tpl_vars['lang']['admincms']['install']; ?>
			...
			<td class="buttons">
			<?php if ($this->_tpl_vars['templates'][$this->_sections['ls']['index']]['default'] == 'false' && $this->_tpl_vars['templates'][$this->_sections['ls']['index']]['installed'] == 1): ?>
			<a href="<?php echo $this->_tpl_vars['templates'][$this->_sections['ls']['index']]['setdefaulturl']; ?>
"><img src="<?php echo $this->_tpl_vars['baseurl']; ?>
/admin/style/icons/small/weather-clear.png" alt="default"/></a>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['templates'][$this->_sections['ls']['index']]['installed'] == 1): ?>
			<a href="<?php echo $this->_tpl_vars['templates'][$this->_sections['ls']['index']]['uninstallurl']; ?>
"><img src="<?php echo $this->_tpl_vars['baseurl']; ?>
