<?php /* Smarty version 2.6.19, created on 2008-08-26 11:44:50
         compiled from l.default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlspecialchars', 'l.default.tpl', 3, false),)), $this); ?>
<ul>
	<?php unset($this->_sections['ln']);
$this->_sections['ln']['name'] = 'ln';
$this->_sections['ln']['loop'] = is_array($_loop=$this->_tpl_vars['list']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
	<li><a href="<?php echo $this->_tpl_vars['list'][$this->_sections['ln']['index']]['link']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['list'][$this->_sections['ln']['index']]['full_title'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
</a></li>
	<?php endfor; endif; ?>
</ul>