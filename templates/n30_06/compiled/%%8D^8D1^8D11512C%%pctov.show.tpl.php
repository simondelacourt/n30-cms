<?php /* Smarty version 2.6.19, created on 2008-06-29 17:30:17
         compiled from pctov.show.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'pctov.show.tpl', 8, false),)), $this); ?>
<?php if (! empty ( $this->_tpl_vars['item']['description'] )): ?><p><?php echo $this->_tpl_vars['item']['description']; ?>
</p><?php endif; ?>
...
$this->_sections['ls']['loop'] = is_array($_loop=$this->_tpl_vars['pictures'][$this->_sections['ln']['index']]) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<td>
<a href="<?php echo $this->_tpl_vars['pictures'][$this->_sections['ln']['index']][$this->_sections['ls']['index']]['link']; ?>
"><img src="<?php echo $this->_tpl_vars['pictures'][$this->_sections['ln']['index']][$this->_sections['ls']['index']]['viewurl']; ?>
" /><br />
<strong><?php echo ((is_array($_tmp=$this->_tpl_vars['pictures'][$this->_sections['ln']['index']][$this->_sections['ls']['index']]['full_title'])) ? $this->_run_mod_handler('substr', true, $_tmp, 0, 10) : substr($_tmp, 0, 10)); ?>
</strong>
</a>
</td>
<?php endfor; endif; ?>
